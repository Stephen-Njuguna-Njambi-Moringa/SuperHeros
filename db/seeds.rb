...
powers= [
    ...
    {name: "flight", description: "gives the wielder the abilito fly through the skys at supersonic speed "},
    {name: "super human senses", description: "allows the person to us their sences at super human level"},
...
heroes = [
    ...
    {name: "Steve Rodgers", super_name: "Captain America"},
    ...
    {name: "Carol Denvers", super_name: "Captain Marvel"},
]

puts " creating heroes...."
heroes.each {|hero| Hero.create(hero)}
HeroPower.create(strength: "Average", hero_id: 11, power_id: 1)
puts " Done!!"